        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <input id="password" name="password" type={showPassword ? "text" : "password"}
              ...
              className="w-full px-4 py-2.5 rounded-lg border border-border bg-white pr-11 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary" />
