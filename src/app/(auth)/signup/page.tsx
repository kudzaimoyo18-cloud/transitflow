    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <button type="button" onClick={() => setMode("rider")}
          className={"flex flex-col items-start gap-1 p-3 rounded-lg border text-left transition-colors " + (mode === "rider" ? "border-border-strong bg-surface" : "border-border hover:border-border-strong")}>
        ...
        <button type="button" onClick={() => setMode("org_owner")}
          className={"flex flex-col items-start gap-1 p-3 rounded-lg border text-left transition-colors " + (mode === "org_owner" ? "border-border-strong bg-surface" : "border-border hover:border-border-strong")}>
      ...
      {error && (
        <div className="mb-6 p-3 rounded-lg bg-danger-soft border border-danger/20 text-danger text-sm">{error}</div>
      )}
      ...
      <p className="mt-6 text-center text-sm text-muted">
        ...
        <Link href="/login" className="text-foreground underline font-medium hover:underline">Sign in</Link>
      </p>
    </>
  );
}
