...
export default async function AnnouncementsPage() {
  ...
  return (
    <>
      <header className="px-6 py-4 border-b border-border bg-background"><h1 className="font-display text-xl font-bold">Announcements</h1><p className="text-sm text-muted">Posts notify every rider instantly.</p></header>
      <div className="p-6 grid lg:grid-cols-3 gap-6">
        ...
        <form action={createAnnouncement} className="rounded-xl border border-border bg-background p-4 space-y-3 h-fit">
          ...
          <button className="w-full py-2 rounded-lg bg-primary hover:bg-primary-dark text-primary-on text-sm font-medium">Post &amp; notify riders</button>
        </form>
      </div>
    </>
  );
