  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <button onClick={() => copy(code)} className="p-2 rounded-lg border border-border hover:bg-surface">{copied ? <Check className="w-4 h-4 text-emerald-600" /> : <Copy className="w-4 h-4" />}</button>
      </div>
